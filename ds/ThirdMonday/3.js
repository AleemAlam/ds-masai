...
// 3 4 4 -1
// Hint
// In the sample test case, the array contains 4 elements, and for the first element, the next greater element will be 3, similarly for the next element, the next greater
// element will be 4, and for the third element as well, the next greater element will be 4. Since, the last element has no elements ahead of it, the next greater
// element will be -1.
...
const nextGreater = (arr, len) => {
  const stack = new Array(len).fill(-1);
  const ans = []; //
